...
class RadarChartWidget extends StatefulWidget {
  ...
  final fashionColor = Colors.purpleAccent;
  final artColor = Colors.blueGrey;
  final boxingColor = Colors.yellow;
  final entertainmentColor = Colors.indigo;
  final ofRoadColor = Colors.red;
